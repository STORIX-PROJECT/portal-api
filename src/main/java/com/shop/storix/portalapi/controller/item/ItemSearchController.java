...
public class ItemSearchController {
    ...
    @GetMapping("/search")
    public ApiResponse<List<ItemSearchDto.ControllerResponse>> searchItem(
           @Valid @ModelAttribute ItemSearchDto.ItemSearchRequest request
    ) {
        List<ItemSearchDto.ControllerResponse> response = itemSearchService.searchItem(request);
